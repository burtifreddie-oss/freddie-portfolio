...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "image-full", src: `/crype-4.png`,        alt: "Crype — Hero / Mockup" },
      { type: "image-full", src: `/crype-5.png`,        alt: "Crype — Símbolo" },
      { type: "image-full", src: `/crype-6.png`,        alt: "Crype — Benchmarking" },
      { type: "image-full", src: `/crype-7.png`,        alt: "Crype — Telas do App" },
      { type: "image-full", src: `/crype-8.jpg`,        alt: "Crype — Telas" },
      { type: "image-full", src: `/crype-wireframe.png`, alt: "Crype — Wireframe + Web" },
    ],
  },
];
